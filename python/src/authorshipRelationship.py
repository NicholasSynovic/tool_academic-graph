...
@click.option(
    ...
    "inputPath",
    type=Path,
    help="Path to OpenAlex JSON Authorship Relationship File generated from Go scripts",
    required=True,
)
@click.option(
    "-o",
    ...
    "outputPath",
    type=Path,
    help="Path to SQLite3 Database to store JSON Authorship Relationship data",
    required=True,
)
@click.option(
    "--chunksize",
